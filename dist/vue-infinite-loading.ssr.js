...
function isVisible(elm) {
  ...
  mounted: function mounted() {
    ...
    eventHub.$on('$InfiniteLoading:loaded', function (obj) {
    ...
    this.stateChanger = {
      loaded: function loaded() {
        var stopContinousLoadIgnoreVisibility = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  return vue.pushScopeId("data-v-73b29e84"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1 = {
...
script.__scopeId = "data-v-73b29e84";// Import vue component
